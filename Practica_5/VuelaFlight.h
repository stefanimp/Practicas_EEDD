...
public:
    ...
    VuelaFlight();
    VuelaFlight(std::ifstream &fichAirports, std::ifstream &fichAerolines, std::ifstream &fichRoutes, std::ifstream &fichFlights, unsigned long int maxAirpotsToInsert, float lambda = 0.7);
    ~VuelaFlight() = default;
    //Otros metodos
