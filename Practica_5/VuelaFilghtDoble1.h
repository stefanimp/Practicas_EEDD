...
#ifndef PRACTICA_2_VUELAFILGHTDOBLE1_H
#define PRACTICA_2_VUELAFILGHTDOBLE1_H
...
public:
    ...
    VuelaFlightDoble1();
    VuelaFlightDoble1(std::ifstream &fichAirports, std::ifstream &fichAerolines, std::ifstream &fichRoutes, std::ifstream &fichFlights, unsigned long int maxAirpotsToInsert, float lambda = 0.7);
    ~VuelaFlightDoble1() = default;
    //Otros metodos
...
#endif //PRACTICA_2_VUELAFILGHTDOBLE1_H
